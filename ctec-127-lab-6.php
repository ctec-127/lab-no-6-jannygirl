...
<body>
    ...
    function convertTemp($temp, $unit1, $unit2)
    {
        ...
        if (is_numeric($temp) == true) {
            ...
            elseif ($unit1 == "--Select--") {
                ...
                echo "<h2>Uh oh...something's not right here.</h2>";
                echo "<p>Please choose a temperature to start with!</p>";
                echo "</div>";
            } elseif ($unit2 == "--Select--") {
                echo "<div class =\"alert\">";
                echo "<h2>Uh oh...something's not right here.</h2>";
                echo "<p>Please choose a temperature to convert to!</p>";
                echo "</div>";
            } 
            // if the temp you're converting to is the same you started with
            elseif ($unit1 == $unit2) {
            $temp = $temp;
            } 
        } else {
            echo "<div class =\"alert\">";
            echo "<h2>Uh oh...something's not right here.</h2>";
            echo "<p>Please enter a numeric value as your temperature.</p>";
            echo "</div>";
        }   
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
        <div class="group">
            ...
            <input type="text" value="<?= isset($originalTemperature) ? $originalTemperature : '' ?>" name="originaltemp" size="14" maxlength="7" id="temp">
